...
calc_emissions <- function(dt, burn_type) {
        ...
        dt[, ':=' (total_fuel_consumed = (total_flamg + total_smoldg + total_resid + flamg_pile + smoldg_pile + resid_pile), 
                   total_pile_consumed = (flamg_pile + smoldg_pile + resid_pile),
        ...
        out_dt <- dt[,list(x, 
                           ...
                           oneK_hr_sound = ((oneK_hr_sound - total_OneK_snd) * oneK_hr_sound_pr) + (pile_load - (flamg_pile + smoldg_pile + resid_pile)),
