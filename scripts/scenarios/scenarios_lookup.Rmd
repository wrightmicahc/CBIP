...
get_sections <- function(fraction_type, col_range) {
        ...
        section <- section %>%
                ...
                transmute(ID = as.integer(ID),
                          ...
                          Stem_ge9 = as.numeric(gsub("[%]", "", `Stem 9+`)),
                          Stem_6t9 = as.numeric(gsub("[%]", "", `Stem 6-9`)),
                          Stem_4t6 = as.numeric(gsub("[%]", "", `Stem 4-6`)),
                          Branch = as.numeric(gsub("[%]", "", Branch)),
                          Foliage = as.numeric(gsub("[%]", "", Foliage))) %>%
