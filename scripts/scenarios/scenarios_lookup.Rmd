...
Load the scenario matrix, and extract the different scenarios. Note that this excludes pulp market scenarios. The ID column needs to be repeated across slope class, fix this.
...
get_sections <- function(fraction_type, col_range) {
        ...
        section <- section %>%
                ...
                transmute(ID = as.integer(ID),
                          Slope_Class = as.numeric(gsub("[LTG]", "", Slope)),
