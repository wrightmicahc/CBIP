...
Partition the snag load to match the other residue using the proportions calculated earlier. Note that this does not include foliage, it assumes that foliage is gone.
